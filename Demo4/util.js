  ...
  //Takes an HTML string that describes a DOM fragment (with a single root) and returns the dom fragment
  ...
  //Takes a URL - loads a dom fragment using get and returns (eventually) the dom fragment
  function httpGetDOMFragment(theUrl)
  {
    var xmlHttp = new XMLHttpRequest();
    xmlHttp.open( "GET", theUrl, false );
    xmlHttp.send( null );
	return DOMFromHTML(xmlHttp.responseText)	
  }
