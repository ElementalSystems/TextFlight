...
var game= {
	...
	addTerrain: function()
	{
		if (this.terrainQueue&&(this.terrainQueue.length>0)) {
			var name=this.terrainQueue[0];
			this.terrainQueue.shift();
			this.addSection(sectionLibrary.getById(name),0,this.backmost_y);
		} else
